...
<!-- ✅ adminEdit 전용 CSS -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/salAdminEdit.css">
</head>
...
<body>
					...
					<div class="container-fluid px-4">
						...
						<div class="edit-header">
							...
							<div class="edit-header-actions">
								<a class="btn-line" href="${pageContext.request.contextPath}/sal/admin/list">목록으로</a>
							</div>
						</div>
						...
						<div class="edit-top-card">
							<div class="top-row">
								<span class="pill">${sal.yearMonthLabel}</span>
								<span class="top-meta">
									사번 <b>${sal.empNo}</b> · 이름 <b>${sal.empName}</b> · 부서 <b>${sal.deptName}</b>
								</span>
							</div>
						</div>
						...
						<!-- =========================
						     3) 정정 폼
						     - POST /sal/admin/edit
						     - null 값은 0으로 안전 처리 (required + number에서 문제 방지)
						     ========================= -->
						<form method="post"
							...
							<div class="grid-2">
								...
								<section class="card">
									...
									<div class="field">
										...
										<div class="input-wrap">
											<input type="number" name="salBase"
												   value="${sal.salBase == null ? 0 : sal.salBase}"
												   class="input" required min="0" step="1">
									...
									<div class="field">
										<label>성과금</label>
										<div class="input-wrap">
											<input type="number" name="salBonus"
												   value="${sal.salBonus == null ? 0 : sal.salBonus}"
												   class="input" required min="0" step="1">
											<span class="unit">원</span>
										</div>
									</div>
									...
									<div class="field">
										<label>기타수당</label>
										<div class="input-wrap">
											<input type="number" name="salPlus"
												   value="${sal.salPlus == null ? 0 : sal.salPlus}"
												   class="input" required min="0" step="1">
											<span class="unit">원</span>
										</div>
									</div>
								...
								<section class="card">
									...
									<div class="field">
										...
										<div class="input-wrap">
											<input type="number" name="insurance"
												   value="${sal.insurance == null ? 0 : sal.insurance}"
												   class="input" required min="0" step="1">
											<span class="unit">원</span>
										</div>
									</div>
									...
									<div class="hint-box">
										<b>Tip</b>
										<div class="hint-text">
											정정 사유는 감사/추적 목적이라 최대한 구체적으로 남겨주세요.
										</div>
									</div>
								</section>
							</div>
							...
							<section class="card card-wide">
								<div class="card-head">
									<h5>정정 사유 <span class="req">(필수)</span></h5>
								</div>

								<textarea name="editReason" class="textarea" rows="4"
							...
							<!-- =========================
							     5) ✅ 변경 전/후 미리보기
							     - UX 안정화: 버튼 위에 배치 (미리보기 보고 저장)
							     - 서버값은 data-before-* 로 전달
							     ========================= -->
							<section class="card card-wide preview-card"
								...
								<div class="preview-detail">
									<div class="mini">
										<span class="k">예상 총 지급</span>
										<span class="v" id="afterPayText">-</span>
									</div>
									<div class="mini">
										<span class="k">예상 공제 합계</span>
										<span class="v" id="afterDeductText">-</span>
									</div>
								</div>
							</section>
							...
							<div class="edit-actions">
								<a class="btn-gray" href="${pageContext.request.contextPath}/sal/admin/list">취소</a>
	...
	<!-- =========================
	     ✅ JS: 미리보기 계산 + 사유 글자수 + submit trim 체크 + confirm
	     ========================= -->
	<script>
	(function () {

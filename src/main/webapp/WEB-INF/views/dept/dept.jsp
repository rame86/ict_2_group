    ...
    <div class="modal-content-custom" style="max-width: 600px;">
        ...
        <div class="modal-body-custom">
            <form id="finalApprovalForm">
                ...
                <input type="hidden" name="DocType" value="APPOINTMENT">
                ...
                <div class="form-group">
                    <label>제목</label>
                    <input type="text" id="draftTitle" name="DocTitle" class="form-control" 
                ...
                <div style="text-align: right; margin-top: 15px;">
                    <button type="button" class="btn-manage-custom" 
                            style="background: #6c757d; border:none;" onclick="closeDraftModal()">취소</button>
                    <button type="button" class="btn-manage-custom" 

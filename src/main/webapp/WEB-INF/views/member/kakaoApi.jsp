...
<script>
  Kakao.init('${0778974e9a5399ae1107ad6380171900}'); // 사용하려는 앱의 JavaScript 키 입력 
...
<script>
  function loginWithKakao() {
    Kakao.Auth.authorize({
      redirectUri: 'http://192.168.0.145:8080/api/kakao/kakaoCallback.jsp',  // 앱에 등록된 카카오 로그인에서 사용할 Redirect URI 입력
    });
  }

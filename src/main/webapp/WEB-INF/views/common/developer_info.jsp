...
@media ( prefers-color-scheme : dark) {
	...
	.badge-super-admin {
		background-color: #2b1b4a !important;
		...
		<div class="modal-content">
			...
			<div class="modal-header bg-dark text-white">
				<h5 class="modal-title" id="developerInfoModalLabel">
					<i class="fas 
fa-laptop-code me-2"></i> ICT Group 2 Middle Project
				</h5>
			...
			<div class="modal-body bg-light">
				<div class="accordion" id="devAccordion">
					...
					<div class="accordion-item">
						...
						<div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#devAccordion">
							<div class="accordion-body">
								<div class="row">

									<div class="col-md-6">
										<div class="feature-title">
											<i class="far fa-clock"></i> 근태 관리
										</div>
									...
									<div class="col-md-6">
										...
										<div class="feature-title">
											<i class="far fa-building"></i> 부서 관리
										</div>
										<ul class="feature-list">
								...
								<div class="row">
									<div class="col-12">
										<div class="feature-title">
											<i class="far fa-comments"></i> 게시판 (공지/자유)
										</div>
						...
						<div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#devAccordion">
							<div class="accordion-body">
								<div class="row">
									...
									<div class="col-md-6">
										<div class="feature-title">
											<i class="far fa-id-card"></i> 사원 관리
										</div>
										<ul class="feature-list">
									...
									<div class="col-md-6">
										<div class="feature-title">
											<i class="fas 
fa-file-invoice-dollar"></i> 급여 관리
										</div>
										<ul class="feature-list">
							...
							<div class="accordion-body">
								...
								<div class="row">
									<div class="col-12">
										...
										<div class="feature-title">
											<i class="fas fa-file-signature"></i> 전자결재
										</div>
									</div>
									<div class="col-md-6">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="feature-title">
											<i class="far fa-envelope"></i> 메시지 (쪽지)
										</div>

	...
	<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
		...
		<ul class="navbar-nav ms-auto me-3 me-lg-4">
			...
			<li class="nav-item dropdown">
				...
				<ul class="dropdown-menu dropdown-menu-end p-0 shadow border-0" aria-labelledby="alertsDropdown" style="width: 270px;">
					<li>
						<h6 class="dropdown-header text-center py-3 bg-warning text-white border-0 rounded-top">새로 온 알람</h6>
					</li>

					<div id="latestAlertsContainer" class="list-group list-group-flush">
					
						<a class="list-group-item list-group-item-action" href="/approve/receiveList">
							<div class="d-flex align-items-center py-2">
								<div class="me-3" style="width: 40px; height: 40px;">
									<div class="icon-circle bg-light p-2 rounded-circle text-primary">
										<i class="fas fa-file-signature"></i>
									</div>
								</div>
								
								<div class="w-100">
									<div class="small text-gray-500 mb-1">김철수 · 5분 전</div>
									<span class="fw-bold text-truncate" style="max-width: 250px;"> [결재 요청] 품의서 제출 (2025년 IT 자산도입) </span>
								</div>
							</div>
						</a>
			...
			<li class="nav-item dropdown">
				...
				<ul class="dropdown-menu dropdown-menu-end p-0 shadow border-0" aria-labelledby="messagesDropdown" style="width: 270px;">
					<li>
						<h6 class="dropdown-header text-center py-3 bg-primary text-white border-0 rounded-top">MESSAGE CENTER</h6>
					</li>
			...
			<li class="nav-item dropdown ps-3 border-left"><a
				class="nav-link dropdown-toggle" id="navbarDropdown" href="#"
				role="button" data-bs-toggle="dropdown" aria-expanded="false"><i
					class="fas fa-user fa-fw"></i></a>
				<ul class="dropdown-menu dropdown-menu-end"
					aria-labelledby="navbarDropdown">
					<li><a class="dropdown-item" href="#!" type="hidden">Settings</a></li>
					<li><a class="dropdown-item" href="#!" type="hidden">Activity Log</a></li>
					<li><hr class="dropdown-divider" /></li>
					<li><a href="/kakao/logout" class="dropdown-item"
						style="color: #EAA8B3; font-weight: bold;">로그아웃</a></li>
				</ul></li>
